...
<div style="display: flex; flex-direction: column; justify-content: center; align-items: center; width: 100%; background-color: #eee; border-radius: 6px; padding-bottom: 20px;">
  ...
  <a href="upi://pay?pa=sanjeev@okaxis&cu=INR&tn=dafdf&am=20" style="text-decoration: none; background-color: #45B7B8; color: #fff; padding: 10px 14px; border-radius: 20px;">PAY NOW</a>
</div>
